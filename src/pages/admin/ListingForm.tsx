...
export function ListingForm() {
    ...
    const { register, handleSubmit, setValue, watch, formState: { errors } } = useForm<ListingFormValues>({
    ...
    const onSubmit = (data: any) => {
        ...
        setTimeout(() => {
            addListing({
                ...
                ...data,
                images: imagePreviews.length > 0 ? imagePreviews : ['https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'], // Placeholder fallback
